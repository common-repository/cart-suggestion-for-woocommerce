	...
	$settings = array(
		'general' => array(
			...
			array(
				...
				'type' => 'textarea',
				'std'  => '<div class="woocommerce-info">Add our <a href="[site_url]?add-to-cart=[id]">[name]</a> for an extra [price]!</div>'
			),
			array(
				'id'   => 'enable_always',
...
function csw_filter_cart_message( $output ) {
	$allowed  = array('div' => array('class' => array(), 'style' => array()),'a' => array('href' => array ()), 'br' => array(), 'p' => array(), 'strong' => array());
